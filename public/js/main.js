...
Hero.prototype.move = function (direction) {
    ...
    // Make hero face the correct direction
...
PlayState._spawnPlatform = function (platform) {
    ...
    // spawn invisible walls to keep spiders on platform
...
PlayState.init = function (data) {
    ...
    // Make hero jump when up arrow is pressed
    this.keys.up.onDown.add(function () {
        this.hero.jump();
    }, this);

    // Play sound affect when hero jumps
    this.keys.up.onDown.add(function () {
